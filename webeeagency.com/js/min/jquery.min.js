!(function (e, t) {
  ...
  function g(e, t) {
    var n,
      ...
      i = 0,
      o =
        typeof e.getElementsByTagName !== Nt
          ? e.getElementsByTagName(t || "*")
          : typeof e.querySelectorAll !== Nt
  ...
  function S(e, t) {
    if (t in e) return t;
    for (
      var n = t.charAt(0).toUpperCase() + t.slice(1), r = t, i = hn.length;
      i--;
  ...
  function M(e, t, n) {
    for (
      var r, i = (wn[t] || []).concat(wn["*"]), o = 0, a = i.length;
      a > o;
      o++
    )
  ...
  function F(e, t, n) {
    ...
    n.queue ||
      ...
      1 === e.nodeType &&
        ...
        "inline" === u &&
          "none" === ot.css(e, "float") &&
          (rt.inlineBlockNeedsLayout && "inline" !== c
            ? (p.zoom = 1)
    ...
    (C = t.support = {}),
          ...
          return n !== H && 9 === n.nodeType && n.documentElement
            ? ((H = n),
              ...
              (N.find.CLASS =
                C.getElementsByClassName &&
                function (e, t) {
                  return typeof t.getElementsByClassName !== V && _
      ...
      (t.matchesSelector = function (e, n) {
        if (
          ...
          (n = n.replace(dt, "='$1']")),
          !(!C.matchesSelector || !_ || (F && F.test(n)) || (M && M.test(n))))
        )
          try {
            var r = O.call(e, n);
            if (
  ...
  (rt.ownLast = "0" !== Ct),
    ...
    ot(function () {
      ...
      n &&
        ...
        typeof t.style.zoom !== Nt &&
          ((t.style.cssText =
            "border:0;margin:0;width:1px;padding:1px;display:inline;zoom:1"),
          (rt.inlineBlockNeedsLayout = 3 === t.offsetWidth) &&
            (n.style.zoom = 1)),
        n.removeChild(e),
        (e = t = null));
    }),
  ...
  (ot.event = {
    ...
    trigger: function (t, n, r, i) {
      ...
      if (
        ...
        if (!i && !u.noBubble && !ot.isWindow(r)) {
          for (
            l = u.delegateType || p, Mt.test(l + p) || (s = s.parentNode);
            s;
            s = s.parentNode
          )
            f.push(s), (c = s);
    ...
    fix: function (e) {
      ...
      for (
        a ||
          (this.fixHooks[i] = a =
            _t.test(i) ? this.mouseHooks : qt.test(i) ? this.keyHooks : {}),
    ...
    (ot.removeEvent = mt.removeEventListener
      ...
      : function (e, t, n) {
          var r = "on" + t;
          e.detachEvent &&
            (typeof e[r] === Nt && (e[r] = null), e.detachEvent(r, n));
        }),
  ...
  (Gt.optgroup = Gt.option),
    ...
    ot.extend({
      clone: function (e, t, n) {
        ...
        if (
          (rt.html5Clone || ot.isXMLDoc(e) || !Pt.test("<" + e.nodeName + ">")
            ? (o = e.cloneNode(!0))
            ...
            if ("object" === ot.type(o)) ot.merge(p, o.nodeType ? [o] : o);
              ...
              if (
                (!rt.leadingWhitespace &&
                  Rt.test(o) &&
                  p.push(t.createTextNode(Rt.exec(o)[0])),
                !rt.tbody)
              )
                for (
                  o =
    ...
    ot.fn.extend({
          ...
          function (e) {
            ...
            if (
              !(
                "string" != typeof e ||
                Xt.test(e) ||
                (!rt.htmlSerialize && Pt.test(e)) ||
                (!rt.leadingWhitespace && Rt.test(e)) ||
                Gt[($t.exec(e) || ["", ""])[1].toLowerCase()]
              )
            ) {
              e = e.replace(Wt, "<$1></$2>");
              try {
      ...
      domManip: function (e, t) {
        ...
        if (
          p ||
          (u > 1 && "string" == typeof f && !rt.checkClone && Ut.test(f))
        )
    ...
    !(function () {
      function t() {
        ...
        r &&
          ...
          ot.swap(r, null != r.style.zoom ? { zoom: 1 } : {}, function () {
            i = 4 === n.offsetWidth;
          }),
          (o = !0),
          (a = !1),
  ...
  ot.extend({
    ...
    ot.each(["height", "width"], function (e, t) {
      ot.cssHooks[t] = {
        get: function (e, n, r) {
          return n
            ? 0 === e.offsetWidth && un.test(ot.css(e, "display"))
              ? ot.swap(e, fn, function () {
                  return L(e, t, r);
                })
              : L(e, t, r)
            : void 0;
    ...
    (ot.cssHooks.marginRight = k(rt.reliableMarginRight, function (e, t) {
      return t
        ? ot.swap(e, { display: "inline-block" }, nn, [e, "marginRight"])
        : void 0;
    })),
      ...
      return arguments.length
        ...
        ? ((t = ot.valHooks[i.type] || ot.valHooks[i.nodeName.toLowerCase()]),
          t && "get" in t && void 0 !== (n = t.get(i, "value"))
            ? n
            : ((n = i.value),
              "string" == typeof n ? n.replace(Tn, "") : null == n ? "" : n))
        : void 0;
    },
  }),
    ot.extend({
    ...
    ot.extend({
      attr: function (e, t, n) {
        ...
        return e && 3 !== o && 8 !== o && 2 !== o
          ? typeof e.getAttribute === Nt
            ? ot.prop(e, t, n)
            : ((1 === o && ot.isXMLDoc(e)) ||
                ((t = t.toLowerCase()),
                (r =
                  ot.attrHooks[t] || (ot.expr.match.bool.test(t) ? Nn : Cn))),
              void 0 === n
      ...
      set: function (e, t, n) {
        return (
          t === !1
            ? ot.removeAttr(e, n)
            : (An && Sn) || !kn.test(n)
            ? e.setAttribute((!Sn && ot.propFix[n]) || n, n)
    ...
    ot.extend({
      ...
      ajax: function (e, t) {
        ...
        (l = d.global),
          ...
          d.hasContent ||
            (d.data &&
              ((o = d.url += (qn.test(o) ? "&" : "?") + d.data), delete d.data),
            d.cache === !1 &&
              (d.url = Bn.test(o)
                ? o.replace(Bn, "$1_=" + Hn++)
                : o + (qn.test(o) ? "&" : "?") + "_=" + Hn++)),
  ...
  (ot.offset = {
    ...
    ot.fn.extend({
      offset: function (e) {
        ...
        return o
          ? ((t = o.documentElement),
            ot.contains(t, i)
              ? (typeof i.getBoundingClientRect !== Nt &&
    ...
    ot.each(["top", "left"], function (e, t) {
      ot.cssHooks[t] = k(rt.pixelPosition, function (e, n) {
        return n
          ? ((n = nn(e, t)), on.test(n) ? ot(e).position()[t] + "px" : n)
          : void 0;
      });
    }),
  ...
  return (
    (ot.noConflict = function (t) {
      return (
        e.$ === ot && (e.$ = sr), t && e.jQuery === ot && (e.jQuery = ar), ot
      );
    }),
